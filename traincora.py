...
from coranet.merit import MERIT
...
parser.add_argument('--drop_edge', type=float, default=0.00001)
parser.add_argument('--drop_feat1', type=float, default=0.0)
...
if __name__ == '__main__':
    ...
    # opt = torch.optim.SGD(merit.parameters(), lr=lr, momentum=0.9, weight_decay=0)#weight_decay)
